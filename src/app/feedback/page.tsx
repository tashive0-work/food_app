...
const FAQS = [
  ...
  },
  {
    ...
    a: "진단 답변을 바탕으로 배고픔, 피로도, 매운맛, 든든함, 온기 등 핵심 취향 수치를 분석하여 200여 개 이상의 메뉴 중 가장 싱크로율이 높은 순서로 정렬합니다.",
  },
  {
    q: "회원가입 없이 무료로 계속 쓸 수 있나요?",
    a: "네! 소비자의 결정 피로를 해결하는 것이 최우선 목적이므로, 모든 추천 및 소리함 기능은 영구히 100% 무료로 이용하실 수 있습니다.",
  },
];
